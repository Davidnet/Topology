...
Sea $ X $ localmente compacto y $ T_2 $ entonces $ X $ admite compactificación de un punto $ \alpha X = X \cup \set{\infty} $, compactificacion de Alexandorff, entonces $ X $ admite compactificacion de un punto $ \alpha X = X \cup \set{\infty} $; $ \alpha \tau = \tau \cup \set{\} $